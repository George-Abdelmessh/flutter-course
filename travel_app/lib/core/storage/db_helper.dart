...
class DBHelper {
  ...
  Future createDB(Database db, int version) async {
    ...
    CREATE TABLE $PLACES_TABLE (
      ...
      FOREIGN KEY ($CATEGORY_ID) REFERENCES $CATEGOIRES_TABLE ($ID) ON DELETE NO ACTION ON UPDATE NO ACTION
      )
    ''');
    ...
    batch.execute('''
    CREATE TABLE $PLACE_FACILITES_TABLE (
      $ID INTEGER PRIMARY KEY AUTOINCREMENT,
